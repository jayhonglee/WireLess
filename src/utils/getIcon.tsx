...
export type IconTypeType = (typeof IconType)[keyof typeof IconType];
...
const getIconSize = (size: IconProps["size"] = "md"): string => {
  switch (size) {
    case "sm":
      return "w-3 h-3";
    case "lg":
...
export const getIcon = (
  ...
  const baseClasses = `${sizeClasses} text-gray-500 ${className}`.trim();

  switch (icon) {
    case IconType.POWER_SOURCE:
      return (
        <svg
